 ...
 *
 * @note Throughou the code, i is assumed that __abase[0] is of type uint32_EGidxLst_t;
...
/** @addtogroup EGidxLst */
/** @{ */
/** @example uint32_eg_idxlist.ex.c 
 * This is a working (althought useless) example on @ref EGidxLst.
 * */
/* ========================================================================= */
#ifndef uint32___EG_IDXLIST_H__
#define uint32___EG_IDXLIST_H__
#include "eg_config.h"
#include "eg_macros.h"
#include "eg_idx.h"
...
#define uint32_EG_IDXLIST_DEBUG 100
/* ========================================================================= */
...
typedef struct uint32_EGidxLst_t
{
	uint32_EGidx_t next;/**< position in the array of the next structure in the list */
	uint32_EGidx_t prev;/**< position in the array of the previous structure in the list */
}
uint32_EGidxLst_t;

/* ========================================================================= */
/** @brief Null-initialized embeded list */
#define uint32_EGidxLstNull ((uint32_EGidxLst_t){.next=uint32_zeroEGidx,.prev=uint32_zeroEGidx})
 ...
 * */
#define uint32_EGidxLstInit(__abase,__stsz,__lpt) do{\
	char*const __EGil01=(__abase);\
	const size_t __EGil02=(__stsz);\
	uint32_EGidxc_t __EGil03=(__lpt);\
	(*((uint32_EGidxLst_t*)(EGaGetElem(__EGil01,__EGil02,__EGil03))))=(uint32_EGidxLst_t){.prev=__EGil03,.next=__EGil03};\
	}while(0)
 ...
 * */
#define uint32___EGidxLstAdd(__abase,__stsz,__newpt,__prevpt,__nextpt) do{\
	...
	uint32_EGidxc_t \
		...
		__EGip07=(__newpt),\
		__EGip08=(__nextpt);\
	(*((uint32_EGidxLst_t*)(EGaGetElem(__EGil05,__EGil06,__EGip07))))=(uint32_EGidxLst_t){.prev=__EGip06,.next=__EGip08},\
((uint32_EGidxLst_t*)(EGaGetElem(__EGil05,__EGil06,__EGip06)))->next=__EGip07,\
((uint32_EGidxLst_t*)(EGaGetElem(__EGil05,__EGil06,__EGip08)))->prev=__EGip07;\
	}while(0)
 ...
 * */
#define uint32_EGidxLstAddAfter(__abase,__stsz,__newpt,__head) do{\
	char*const __EGil11=(__abase);\
	size_t const __EGil12=(__stsz);\
	uint32_EGidxc_t __EGip10=(__head),\
		__EGip11=(__newpt),\
		__EGip12=((uint32_EGidxLst_t*)(EGaGetElem(__EGil11,__EGil12,__EGip10)))->next;\
	uint32___EGidxLstAdd(__EGil11,__EGil12,__EGip11,__EGip10,__EGip12);\
	}while(0)
 ...
 * */
#define uint32_EGidxLstAddBefore(__abase,__stsz,__newpt,__tailpt) do{\
	char*const __EGil20=(__abase);\
	size_t const __EGil21=(__stsz);\
	uint32_EGidxc_t __EGil23=(__newpt),\
		__EGil24=(__tailpt),\
		__EGil22=((uint32_EGidxLst_t*)(EGaGetElem(__EGil20,__EGil21,__EGil24)))->prev;\
	uint32___EGidxLstAdd(__EGil20,__EGil21,__EGil23,__EGil22,__EGil24);\
	}while(0)
 ...
 * */
#define uint32___EGidxLstLink(__abase,__stsz,__prevpt,__nextpt) do{\
	char*const __EGil25=(__abase);\
	size_t const __EGil26=(__stsz);\
	uint32_EGidxc_t __EGil27=(__prevpt),\
		__EGil28=(__nextpt);\
	((uint32_EGidxLst_t*)(EGaGetElem(__EGil25,__EGil26,__EGil27)))->next=__EGil28,\
	((uint32_EGidxLst_t*)(EGaGetElem(__EGil25,__EGil26,__EGil28)))->prev=__EGil27;\
	}while(0)
 ...
 * */
#define uint32_EGidxLstDel(__abase,__stsz,__entry) do{\
	char*const __EGil29=(__abase);\
	size_t const __EGil30=(__stsz);\
	uint32_EGidxc_t __EGil31=(__entry);\
	uint32_EGidxLst_t*const __EGil32 = (uint32_EGidxLst_t*)(EGaGetElem(__EGil29,__EGil30,__EGil31));\
	uint32___EGidxLstLink(__EGil29,__EGil30,__EGil32->prev,__EGil32->next);\
	if(uint32_EG_IDXLIST_DEBUG <= DEBUG) (*__EGil32) = (uint32_EGidxLst_t){.next=uint32_MaxEGidx,.prev=uint32_MaxEGidx};\
	} while(0)
 ...
 * @param __stsz size of each basic structure (i.e. sizeof(main structure))
 * */
#define uint32_EGidxLstReplace(__abase,__stsz,__oldpt,__newpt) do{\
	char*const __EGil33=(__abase);\
	size_t const __EGil34=(__stsz);\
	uint32_EGidxc_t __EGil36=(__newpt);\
	uint32_EGidxLst_t*const __EGil37=((uint32_EGidxLst_t*)(EGaGetElem(__EGil33,__EGil34,(__oldpt))));\
	/* copy contents in old member to replaciong member */\
	(*((uint32_EGidxLst_t*)(EGaGetElem(__EGil33,__EGil34,__EGil36))))=*__EGil37,\
	/* modify next/prev of neighbours */\
	((uint32_EGidxLst_t*)(EGaGetElem(__EGil33,__EGil34,__EGil37->next)))->prev=__EGil36,\
	((uint32_EGidxLst_t*)(EGaGetElem(__EGil33,__EGil34,__EGil37->prev)))->next=__EGil36;\
	}while(0)
 ...
 * @param __stsz size of each basic structure (i.e. sizeof(main structure))
 * */
#define uint32_EGidxLstMoveAfter(__abase,__stsz,__entry,__head) do{\
	char*const __EGil38=(__abase);\
	size_t const __EGil39=(__stsz);\
	uint32_EGidxc_t __EGil40=(__entry);\
	uint32_EGidxLst_t*const __EGil41=((uint32_EGidxLst_t*)(EGaGetElem(__EGil38,__EGil39,__EGil40)));\
	uint32___EGidxLstLink(__EGil38,__EGil39,__EGil41->prev,__EGil41->next);\
	uint32_EGidxLstAddAfter(__EGil38,__EGil39,__EGil40,(__head));\
	}while(0)
 ...
 * */
#define uint32_EGidxLstMoveBefore(__abase,__stsz,__entry,__tailpt) do{\
	char*const __EGil42=(__abase);\
	size_t const __EGil43=(__stsz);\
	uint32_EGidxc_t __EGil44=(__entry);\
	uint32_EGidxLst_t*const __EGil45=((uint32_EGidxLst_t*)(EGaGetElem(__EGil42,__EGil43,__EGil44)));\
	uint32___EGidxLstLink(__EGil42,__EGil43,__EGil45->prev,__EGil45->next);\
	uint32_EGidxLstAddBefore(__EGil42,__EGil43,__EGil44,(__tailpt));\
	}while(0)
 ...
 * */
#define uint32_EGidxLstSplice(__abase,__stsz,__list,__head) do{\
	char*const __EGil46=(__abase);\
	size_t const __EGil47=(__stsz);\
	uint32_EGidxc_t __EGil48=(__list),__EGil49=(__head);\
	uint32_EGidxc_t __EGil52=((uint32_EGidxLst_t*)(EGaGetElem(__EGil46,__EGil47,__EGil48)))->prev,\
					 __EGil53=((uint32_EGidxLst_t*)(EGaGetElem(__EGil46,__EGil47,__EGil49)))->prev;\
	uint32___EGidxLstLink(__EGil46,__EGil47,__EGil52,__EGil49);\
	uint32___EGidxLstLink(__EGil46,__EGil47,__EGil53,__EGil48);\
	}while(0)

/* ========================================================================= */
/** @}*/
/* end of uint32_eg_idxlist.h */
#endif
