...
static const char *roundingPrecisionName,
 *roundingModeName,
 *tininessModeName;
static void reportTime (
	...
	long clocks)
{
	printf ("%8.1f kops/s: %s",
					(count / (((float) clocks) / CLOCKS_PER_SEC)) / 1000, functionName);
	if (roundingModeName)
	{
...
static const int32 inputs_int32[numInputs_int32] =
	{ 0xFFFFBB79, 0x405CF80F, 0x00000000, 0xFFFFFD04, 0xFFF20002, 0x0C8EF795,
	0xF00011FF, 0x000006CA, 0x00009BFE, 0xFF4862E3, 0x9FFFEFFE, 0xFFFFFFB7,
	0x0BFF7FFF, 0x0000F37A, 0x0011DFFE, 0x00000006,
	0xFFF02006, 0xFFFFF7D1, 0x10200003, 0xDE8DF765, 0x00003E02, 0x000019E8,
	0x0008FFFE, 0xFFFFFB5C, 0xFFDF7FFE, 0x07C42FBF,
	0x0FFFE3FF, 0x040B9F13, 0xBFFFFFF8, 0x0001BF56, 0x000017F6, 0x000A908A
};
static void time_a_int32_z_float32 (
	float32 function (int32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_int32_z_float64 (
	float64 function (int32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOATX80
static void time_a_int32_z_floatx80 (
	floatx80 function (int32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOAT128
static void time_a_int32_z_float128 (
	float128 function (int32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static const int64 inputs_int64[numInputs_int64] =
	{ LIT64 (0xFBFFC3FFFFFFFFFF), LIT64 (0x0000000003C589BC),
	LIT64 (0x00000000400013FE), LIT64 (0x0000000000186171),
	LIT64 (0xFFFFFFFFFFFEFBFA), LIT64 (0xFFFFFD79E6DFFC73),
	LIT64 (0x0000000010001DFF), LIT64 (0xDD1A0F0C78513710),
	LIT64 (0xFFFF83FFFFFEFFFE), LIT64 (0x00756EBD1AD0C1C7),
	LIT64 (0x0003FDFFFFFFFFBE), LIT64 (0x0007D0FB2C2CA951),
	LIT64 (0x0007FC0007FFFFFE), LIT64 (0x0000001F942B18BB),
	LIT64 (0x0000080101FFFFFE), LIT64 (0xFFFFFFFFFFFF0978),
	LIT64 (0x000000000008BFFF), LIT64 (0x0000000006F5AF08),
	LIT64 (0xFFDEFF7FFFFFFFFE), LIT64 (0x0000000000000003),
	LIT64 (0x3FFFFFFFFF80007D), LIT64 (0x0000000000000078),
	LIT64 (0xFFF80000007FDFFD), LIT64 (0x1BBC775B78016AB0),
	LIT64 (0xFFF9001FFFFFFFFE), LIT64 (0xFFFD4767AB98E43F),
	LIT64 (0xFFFFFEFFFE00001E), LIT64 (0xFFFFFFFFFFF04EFD),
	LIT64 (0x07FFFFFFFFFFF7FF), LIT64 (0xFFFC9EAA38F89050),
	LIT64 (0x00000020FBFFFFFE), LIT64 (0x0000099AE6455357)
};
static void time_a_int64_z_float32 (
	float32 function (int64))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_int64_z_float64 (
	float64 function (int64))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOAT128
static void time_a_int64_z_float128 (
	float128 function (int64))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static const float32 inputs_float32[numInputs_float32] =
	{ 0x4EFA0000, 0xC1D0B328, 0x80000000, 0x3E69A31E, 0xAF803EFF, 0x3F800000,
	0x17BF8000, 0xE74A301A, 0x4E010003, 0x7EE3C75D, 0xBD803FE0, 0xBFFEFF00,
	0x7981F800, 0x431FFFFC, 0xC100C000, 0x3D87EFFF,
	0x4103FEFE, 0xBC000007, 0xBF01F7FF, 0x4E6C6B5C, 0xC187FFFE, 0xC58B9F13,
	0x4F88007F, 0xDF004007, 0xB7FFD7FE, 0x7E8001FB,
	0x46EFFBFF, 0x31C10000, 0xDB428661, 0x33F89B1F, 0xA3BFEFFF, 0x537BFFBE
};
static void time_a_float32_z_int32 (
	int32 function (float32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_float32_z_int64 (
	int64 function (float32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_float32_z_float64 (
	float64 function (float32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOATX80
static void time_a_float32_z_floatx80 (
	floatx80 function (float32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOAT128
static void time_a_float32_z_float128 (
	float128 function (float32))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_ab_float32_z_flag (
	flag function (float32,
								 float32))
{
	clock_t startClock,
	  endClock;
	...
	do
	{
		for (i = minIterations; i; --i)
		{
			function (inputs_float32[inputNumA], inputs_float32[inputNumB]);
...
static const float32 inputs_float32_pos[numInputs_float32] =
	{ 0x4EFA0000, 0x41D0B328, 0x00000000, 0x3E69A31E, 0x2F803EFF, 0x3F800000,
	0x17BF8000, 0x674A301A, 0x4E010003, 0x7EE3C75D, 0x3D803FE0, 0x3FFEFF00,
	0x7981F800, 0x431FFFFC, 0x4100C000, 0x3D87EFFF, 0x4103FEFE,
	0x3C000007, 0x3F01F7FF, 0x4E6C6B5C, 0x4187FFFE, 0x458B9F13, 0x4F88007F,
	0x5F004007, 0x37FFD7FE, 0x7E8001FB, 0x46EFFBFF, 0x31C10000,
	0x5B428661, 0x33F89B1F, 0x23BFEFFF, 0x537BFFBE
};
static void time_az_float32_pos (
	float32 function (float32))
{
	clock_t startClock,
	  endClock;
...
static const float64 inputs_float64[numInputs_float64] =
	{ LIT64 (0x422FFFC008000000), LIT64 (0xB7E0000480000000),
	LIT64 (0xF3FD2546120B7935), LIT64 (0x3FF0000000000000),
	LIT64 (0xCE07F766F09588D6), LIT64 (0x8000000000000000),
	LIT64 (0x3FCE000400000000), LIT64 (0x8313B60F0032BED8),
	LIT64 (0xC1EFFFFFC0002000), LIT64 (0x3FB3C75D224F2B0F),
	LIT64 (0x7FD00000004000FF), LIT64 (0xA12FFF8000001FFF),
	LIT64 (0x3EE0000000FE0000), LIT64 (0x0010000080000004),
	LIT64 (0x41CFFFFE00000020), LIT64 (0x40303FFFFFFFFFFD),
	LIT64 (0x3FD000003FEFFFFF), LIT64 (0xBFD0000010000000),
	LIT64 (0xB7FC6B5C16CA55CF), LIT64 (0x413EEB940B9D1301),
	LIT64 (0xC7E00200001FFFFF), LIT64 (0x47F00021FFFFFFFE),
	LIT64 (0xBFFFFFFFF80000FF), LIT64 (0xC07FFFFFE00FFFFF),
	LIT64 (0x001497A63740C5E8), LIT64 (0xC4BFFFE0001FFFFF),
	LIT64 (0x96FFDFFEFFFFFFFF), LIT64 (0x403FC000000001FE),
	LIT64 (0xFFD00000000001F6), LIT64 (0x0640400002000000),
	LIT64 (0x479CEE1E4F789FE0), LIT64 (0xC237FFFFFFFFFDFE)
};
static void time_a_float64_z_int32 (
	int32 function (float64))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_float64_z_float32 (
...
#ifdef FLOAT128
static void time_a_float64_z_float128 (
	float128 function (float64))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_ab_float64_z_flag (
	flag function (float64,
								 float64))
{
	clock_t startClock,
	  endClock;
	...
	do
	{
		for (i = minIterations; i; --i)
		{
			function (inputs_float64[inputNumA], inputs_float64[inputNumB]);
...
static const float64 inputs_float64_pos[numInputs_float64] =
	{ LIT64 (0x422FFFC008000000), LIT64 (0x37E0000480000000),
	LIT64 (0x73FD2546120B7935), LIT64 (0x3FF0000000000000),
	LIT64 (0x4E07F766F09588D6), LIT64 (0x0000000000000000),
	LIT64 (0x3FCE000400000000), LIT64 (0x0313B60F0032BED8),
	LIT64 (0x41EFFFFFC0002000), LIT64 (0x3FB3C75D224F2B0F),
	LIT64 (0x7FD00000004000FF), LIT64 (0x212FFF8000001FFF),
	LIT64 (0x3EE0000000FE0000), LIT64 (0x0010000080000004),
	LIT64 (0x41CFFFFE00000020), LIT64 (0x40303FFFFFFFFFFD),
	LIT64 (0x3FD000003FEFFFFF), LIT64 (0x3FD0000010000000),
	LIT64 (0x37FC6B5C16CA55CF), LIT64 (0x413EEB940B9D1301),
	LIT64 (0x47E00200001FFFFF), LIT64 (0x47F00021FFFFFFFE),
	LIT64 (0x3FFFFFFFF80000FF), LIT64 (0x407FFFFFE00FFFFF),
	LIT64 (0x001497A63740C5E8), LIT64 (0x44BFFFE0001FFFFF),
	LIT64 (0x16FFDFFEFFFFFFFF), LIT64 (0x403FC000000001FE),
	LIT64 (0x7FD00000000001F6), LIT64 (0x0640400002000000),
	LIT64 (0x479CEE1E4F789FE0), LIT64 (0x4237FFFFFFFFFDFE)
};
static void time_az_float64_pos (
	float64 function (float64))
{
	clock_t startClock,
	  endClock;
...
static void time_a_floatx80_z_int64 (
	int64 function (floatx80))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_floatx80_z_float32 (
	float32 function (floatx80))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOAT128
static void time_a_floatx80_z_float128 (
	float128 function (floatx80))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#endif /*  */
static void time_az_floatx80 (
	floatx80 function (floatx80))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_ab_floatx80_z_flag (
	flag function (floatx80,
								 floatx80))
{
	clock_t startClock,
	  endClock;
...
static void time_az_floatx80_pos (
	floatx80 function (floatx80))
{
	clock_t startClock,
	  endClock;
...
static void time_a_float128_z_int32 (
	int32 function (float128))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_float128_z_int64 (
	int64 function (float128))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_a_float128_z_float32 (
	float32 function (float128))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
#ifdef FLOATX80
static void time_a_float128_z_floatx80 (
	floatx80 function (float128))
{
	clock_t startClock,
	  endClock;
	int32 count,
...
static void time_az_float128_pos (
	float128 function (float128))
{
	clock_t startClock,
	  endClock;
...
#endif /*  */
enum
{ INT32_TO_FLOAT32 = 1, INT32_TO_FLOAT64,
#ifdef FLOATX80
	INT32_TO_FLOATX80,
#endif /*  */
#ifdef FLOAT128
	INT32_TO_FLOAT128,
#endif /*  */
	INT64_TO_FLOAT32, INT64_TO_FLOAT64,
#ifdef FLOATX80
	INT64_TO_FLOATX80,
#endif /*  */
#ifdef FLOAT128
	INT64_TO_FLOAT128,
#endif /*  */
	FLOAT32_TO_INT32, FLOAT32_TO_INT32_ROUND_TO_ZERO, FLOAT32_TO_INT64,
	FLOAT32_TO_INT64_ROUND_TO_ZERO, FLOAT32_TO_FLOAT64,
#ifdef FLOATX80
	FLOAT32_TO_FLOATX80,
#endif /*  */
#ifdef FLOAT128
	FLOAT32_TO_FLOAT128,
#endif /*  */
	FLOAT32_ROUND_TO_INT, FLOAT32_ADD, FLOAT32_SUB, FLOAT32_MUL,
	FLOAT32_DIV, FLOAT32_REM, FLOAT32_SQRT, FLOAT32_EQ, FLOAT32_LE,
	FLOAT32_LT, FLOAT32_EQ_SIGNALING, FLOAT32_LE_QUIET, FLOAT32_LT_QUIET,
	FLOAT64_TO_INT32, FLOAT64_TO_INT32_ROUND_TO_ZERO, FLOAT64_TO_INT64,
	...
	FLOAT64_TO_FLOAT128,
#endif /*  */
	FLOAT64_ROUND_TO_INT, FLOAT64_ADD, FLOAT64_SUB, FLOAT64_MUL,
	FLOAT64_DIV, FLOAT64_REM, FLOAT64_SQRT, FLOAT64_EQ, FLOAT64_LE,
	FLOAT64_LT, FLOAT64_EQ_SIGNALING, FLOAT64_LE_QUIET, FLOAT64_LT_QUIET,
#ifdef FLOATX80
	FLOATX80_TO_INT32, FLOATX80_TO_INT32_ROUND_TO_ZERO, FLOATX80_TO_INT64,
	FLOATX80_TO_INT64_ROUND_TO_ZERO, FLOATX80_TO_FLOAT32,
	FLOATX80_TO_FLOAT64,
#ifdef FLOAT128
	FLOATX80_TO_FLOAT128,
#endif /*  */
	FLOATX80_ROUND_TO_INT, FLOATX80_ADD, FLOATX80_SUB, FLOATX80_MUL,
	FLOATX80_DIV, FLOATX80_REM, FLOATX80_SQRT, FLOATX80_EQ, FLOATX80_LE,
	FLOATX80_LT, FLOATX80_EQ_SIGNALING, FLOATX80_LE_QUIET,
	FLOATX80_LT_QUIET,
#endif /*  */
#ifdef FLOAT128
	FLOAT128_TO_INT32, FLOAT128_TO_INT32_ROUND_TO_ZERO, FLOAT128_TO_INT64,
	FLOAT128_TO_INT64_ROUND_TO_ZERO, FLOAT128_TO_FLOAT32,
	FLOAT128_TO_FLOAT64,
#ifdef FLOATX80
	FLOAT128_TO_FLOATX80,
#endif /*  */
	FLOAT128_ROUND_TO_INT, FLOAT128_ADD, FLOAT128_SUB, FLOAT128_MUL,
	FLOAT128_DIV, FLOAT128_REM, FLOAT128_SQRT, FLOAT128_EQ, FLOAT128_LE,
	FLOAT128_LT, FLOAT128_EQ_SIGNALING, FLOAT128_LE_QUIET,
	FLOAT128_LT_QUIET,
#endif /*  */
	NUM_FUNCTIONS
};
...
enum
{ ROUND_NEAREST_EVEN =
		1, ROUND_TO_ZERO, ROUND_DOWN, ROUND_UP, NUM_ROUNDINGMODES
};
enum
{ TININESS_BEFORE_ROUNDING = 1, TININESS_AFTER_ROUNDING, NUM_TININESSMODES
};
static void timeFunctionVariety (
...
static void timeFunction (
	unsigned functionCode,
	int roundingPrecisionIn,
	int roundingModeIn,
	int tininessModeIn)
{
	int roundingPrecision,
	...
	for (;;)
	{
		...
		for (roundingMode = 1; roundingMode < NUM_ROUNDINGMODES; ++roundingMode)
		{
			...
			for (tininessMode = 1; tininessMode < NUM_TININESSMODES; ++tininessMode)
			{
				if ((roundingPrecision == 32) || (roundingPrecision == 64))
				{
				...
				timeFunctionVariety (functionCode, roundingPrecision, roundingMode,
														 tininessMode);
				if (tininessModeIn || !tininessMode)
					break;
			}
	...
	char **argv)
{
	...
	while (argc && (argPtr = argv[0]))
	{
		...
		{
		writeHelpMessage:fputs ("timesoftfloat [<option>...] <function>\n"
						 "  <option>:  (* is default)\n"
	...
	else if (operands == 1)
	{
		for (functionCode = 1; functionCode < NUM_FUNCTIONS; ++functionCode)
		{
			...
			{
				timeFunction (functionCode, roundingPrecision, roundingMode,
											tininessMode);
			}
		}
	}
