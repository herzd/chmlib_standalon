 ...
 *
 * @note Throughou the code, i is assumed that __abase[0] is of type EGa32List_t;
...
/** @file 
 * @ingroup EGa32List */
/** @addtogroup EGa32List */
/** @{ */
/** @example eg_a32list.ex.c 
 * This is a working (althought useless) example on @ref EGa32List.
 * */
/* ========================================================================= */
#ifndef __EG_A32LIST_H__
#define __EG_A32LIST_H__
#include "eg_config.h"
#include "eg_macros.h"

/* ========================================================================= */
/** @brief debug level for lists */
#define EG_A32LIST_DEBUG 100
/* ========================================================================= */
...
typedef struct EGa32List_t
{
	uint32_t next;/**< position in the array of the next structure in the list */
	uint32_t prev;/**< position in the array of the previous structure in the list */
}
EGa32List_t;

/* ========================================================================= */
/** @brief Null-initialized embeded list */
#define EGa32ListNull ((EGa32List_t){0,0})
 ...
 * */
#define EGa32ListInit(__abase,__stsz,__lpt) do{\
	char*const __EGabase=(__abase);\
	size_t const __EGasz=(__stsz);\
	const uint32_t __EGacpos=(__lpt);\
	EGa32List_t*const __EGalp=((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGacpos)));\
 ...
 * */
#define __EGa32ListAdd(__abase,__stsz,__newpt,__prevpt,__nextpt) do{\
	char*const __EGabase=(__abase);\
	size_t const __EGasz=(__stsz);\
	const uint32_t __EGacpos=(__newpt), __EGappos=(__prevpt), __EGanpos=(__nextpt);\
	EGa32List_t*const __EGeL_add_new = ((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGacpos))),\
	*const __EGeL_add_prev = ((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGappos))),\
	*const __EGeL_add_next = ((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGanpos)));\
 ...
 * */
#define EGa32ListAddAfter(__abase,__stsz,__newpt,__head) do{\
	char*const __EGabase2=(__abase);\
	size_t const __EGasz2=(__stsz);\
	const uint32_t __EGa1pos=(__head),__EGa2pos=(__newpt);\
	EGa32List_t*const __EGa1t=((EGa32List_t*)(EGaGetElem(__EGabase2,__EGasz2,__EGa1pos)));\
	const uint32_t __EGa3pos=__EGa1t->next;\
	__EGa32ListAdd(__EGabase2,__EGasz2,__EGa2pos,__EGa1pos,__EGa3pos);\
	}while(0)
 ...
 * */
#define EGa32ListAddBefore(__abase,__stsz,__newpt,__tailpt) do{\
	char*const __EGabase2=(__abase);\
	size_t const __EGasz2=(__stsz);\
	const uint32_t __EGa2pos=(__newpt),__EGa3pos=(__tailpt);\
	EGa32List_t*const __EGa3t=((EGa32List_t*)(EGaGetElem(__EGabase2,__EGasz2,__EGa3pos)));\
	const uint32_t __EGa1pos=__EGa3t->prev;\
	__EGa32ListAdd(__EGabase2,__EGasz2,__EGa2pos,__EGa1pos,__EGa3pos);\
	}while(0)
 ...
 * */
#define __EGa32ListLink(__abase,__stsz,__prevpt,__nextpt) do{\
	char*const __EGabase=(__abase);\
	size_t const __EGasz=(__stsz);\
	const uint32_t __EGappos=(__prevpt),__EGanpos=(__nextpt);\
	EGa32List_t*const __EGeL_lnk_prev = (EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGappos)),\
	*const __EGeL_lnk_next = (EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGanpos));\
 ...
 * */
#define EGa32ListDel(__abase,__stsz,__entry) do{\
	char*const __EGabase2=(__abase);\
	size_t const __EGasz2=(__stsz);\
	const uint32_t __EGacpos=(__entry);\
	EGa32List_t *const __EGeL_del_entr = (EGa32List_t*)(EGaGetElem(__EGabase2,__EGasz2,__EGacpos));\
	__EGa32ListLink(__EGabase2,__EGasz2,__EGeL_del_entr->prev,__EGeL_del_entr->next);\
	if(EG_A32LIST_DEBUG <= DEBUG) (*__EGeL_del_entr) = (EGa32List_t){INT_MAX,INT_MAX};\
	} while(0)
 ...
 * @param __stsz size of each basic structure (i.e. sizeof(main structure))
 * */
#define EGa32ListReplace(__abase,__stsz,__oldpt,__newpt) do{\
	char*const __EGabase=(__abase);\
	size_t const __EGasz=(__stsz);\
	const uint32_t __EGaopos=(__oldpt), __EGacpos=(__newpt);\
	EGa32List_t*const __EGaopt=((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGaopos))),\
	*const __EGacpt=((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGacpos)));\
	EGa32List_t*const __EGanpt=((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGaopt->next))),\
	*const __EGappt=((EGa32List_t*)(EGaGetElem(__EGabase,__EGasz,__EGaopt->prev)));\
 ...
 * @param __stsz size of each basic structure (i.e. sizeof(main structure))
 * */
#define EGa32ListMoveAfter(__abase,__stsz,__entry,__head) do{\
	char*const __EGabase3=(__abase);\
	size_t const __EGasz3=(__stsz);\
	const uint32_t __EGaepos=(__entry),__EGahpos=(__head);\
	EGa32List_t*const __EGaept=((EGa32List_t*)(EGaGetElem(__EGabase3,__EGasz3,__EGaepos)));\
	__EGa32ListLink(__EGabase3,__EGasz3,__EGaept->prev,__EGaept->next);\
	EGa32ListAddAfter(__EGabase3,__EGasz3,__EGaepos,__EGahpos);\
	}while(0)
 ...
 * */
#define EGa32ListMoveBefore(__abase,__stsz,__entry,__tailpt) do{\
	char*const __EGabase3=(__abase);\
	size_t const __EGasz3=(__stsz);\
	const uint32_t __EGaepos=(__entry),__EGatpos=(__tailpt);\
	EGa32List_t*const __EGaept=((EGa32List_t*)(EGaGetElem(__EGabase3,__EGasz3,__EGaepos)));\
	__EGa32ListLink(__EGabase3,__EGasz3,__EGaept->prev,__EGaept->next);\
	EGa32ListAddBefore(__EGabase3,__EGasz3,__EGaepos,__EGatpos);\
	}while(0)
 ...
 * */
#define EGa32ListSplice(__abase,__stsz,__list,__head) do{\
	char*const __EGabase2=(__abase);\
	size_t const __EGasz2=(__stsz);\
	const uint32_t __EGap10=(__list),__EGap20=(__head);\
	EGa32List_t*const __EGat10=((EGa32List_t*)(EGaGetElem(__EGabase2,__EGasz2,__EGap10))),\
	*const __EGat20=((EGa32List_t*)(EGaGetElem(__EGabase2,__EGasz2,__EGap20)));\
	const uint32_t __EGap11=__EGat10->prev,__EGap21=__EGat20->prev;\
	__EGa32ListLink(__EGabase2,__EGasz2,__EGap11,__EGap20);\
	__EGa32ListLink(__EGabase2,__EGasz2,__EGap21,__EGap10);\
	}while(0)
