 ...
 * */
#ifndef uint8__EG_IDXNUM_H__
#define uint8__EG_IDXNUM_H__
/** @file
 * @ingroup EGidxNum */
/** @addtogroup EGidxNum */
/** @{ */
...
#define uint8_zeroEGidx ((uint8_t)0U)	/**<@brief zero-valued constant */
#define uint8_oneEGidx 	((uint8_t)1U)	/**<@brief one-valued constant */
#define uint8_MaxEGidx 	UINT8_MAX			/**<@brief maximum representable value */
#define uint8_EGidx_t uint8_t					/**<@brief typedef for modifiable l-value */
#define uint8_EGidxc_t const uint8_t	/**<@brief typedef for constant values */
/* ========================================================================= */
 ...
 * */
#define uint8_EGstrtoIdx(__nptr__,__endptr__,__base__) strtoul(__nptr__,__endptr,__base__)
/* ========================================================================= */
 ...
 * @return EGidx_t
 * detail. */
#define uint8_EG_UL2idx(__EGidxul__)	((uint8_t)(__EGidxul__))
/* ========================================================================= */
 ...
 * */
#define uint8_EGidxIsEqqual(__EGPa__,__EGPb__) ((__EGPa__)==(__EGPb__))
/* ========================================================================= */
 ...
 * */
#define uint8_EGidxIsLess(__EGPa__,__EGPb__) ((__EGPa__)<(__EGPb__))
/* ========================================================================= */
 ...
 * */
#define uint8_EGidxIsLeq(__EGPa__,__EGPb__) ((__EGPa__)<=(__EGPb__))
/* ========================================================================= */
 ...
 * */
#define uint8_EGidxAdd(__EGPa__,__EGPb__)	((uint8_t)((__EGPa__)+(__EGPb__)))
/* ========================================================================= */
 ...
 * */
#define uint8_EGidxSub(__EGPa__,__EGPb__) ((uint8_t)((__EGPa__)-(__EGPb__)))
/* ========================================================================= */
 ...
 * @return  __EGPa__ * __EGPb__
 * */
#define uint8_EGidxMult(__EGPa__,__EGPb__) ((uint8_t)((__EGPa__)*(__EGPb__)))
/* ========================================================================= */
 ...
 * */
#define uint8_EGidxDiv(__EGPa__,__EGPb__) ((uint8_t)((__EGPa__)/(__EGPb__)))
/* ========================================================================= */
/** @brief set the value of the variable to zero */
#define uint8_EGidxZero(__EGPa__) uint8_zeroEGidx
/* ========================================================================= */
/** @brief Reset the value of the pointed number to one.
 * @param __EGPa__ EGidx_t value to be set to one.
 * */
#define uint8_EGidxOne(__EGPa__) uint8_oneEGidx
/* ========================================================================= */
/** @brief unary plus plus operator */
#define uint8_EGidxPP(__EGPa__) ((__EGPa__)++)
/* ========================================================================= */
 ...
 * */
#define uint8_PRIuidxFmt PRIu8
#define uint8_PRIuidxArg(__EGPa__) ((uint8_t)(__EGPa__))
#endif
 /** @} */
/* ========================================================================= */
