...
void EGalgAPRprofile(void)
{
	...
	fprintf(stderr,"PROFILE FOR EGalgPushRelabel:\nnpush %llu\n"\
					"nrela %llu\nnlevl %llu\nnmove %llu\nnnumb %llu\n", \
					__APR_profile_push, __APR_profile_rela, __APR_profile_lvel, \
					__APR_profile_move,__APR_profile_numb); __APR_profile_push = \
					__APR_profile_numb = __APR_profile_lvel = __APR_profile_move = \
					__APR_profile_rela = 0;
	}
}
#if __PR_PROFILE__ <= DEBUG
