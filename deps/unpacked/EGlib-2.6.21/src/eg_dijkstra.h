...
/** @{ */
/** @example eg_dijkstra.ex.c */
/* ========================================================================= */
#ifndef __EG_DIJKSTRA_H
#define __EG_DIJKSTRA_H
#include "eg_config.h"
...
#define DJK_VRBLVL_ 100

/* ========================================================================= */
/** @brief Level of profiling in the code. */
#define DJK_DEBUG_ 100
 ...
 * that this array will be allocated using EGlpNumAllocArray, and should be
 * deallocated using EGlpNumFreeArray.
