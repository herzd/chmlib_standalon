 ...
 * @param __dmatrix dense matrix structure pointer.
 * */
#define EGdMatrixClear(__dmatrix) do{\
 ...
 * */
#define EGdMatrixSetDimension(__dmatrix,__nnewrows,__nnewcols) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
 ...
 * printed.
 * */
#define EGdMatrixDisplay(__dmatrix,__nat_order,__ofile) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
	char* __EGdmstr = 0;\
 ...
 * operation.
 * */
#define EGdMatrixAddRowMultiple(__dmatrix,__dest,__orig,__num) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
 ...
 * operation.
 * */
#define EGdMatrixSubRowMultiple(__dmatrix,__dest,__orig,__num) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
 ...
 * */
#define EGdMatrixMultiplyRow(__dmatrix,row_ind,multiple) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
 ...
 * */
#define EGdMatrixAddColMultiple(__dmatrix,__dest,__orig,__num) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
	const size_t __EGdest = (__dest);\
	const size_t __EGori = (__orig);\
 ...
 * always perform the operation.
 * */
#define EGdMatrixSubColMultiple(__dmatrix,__dest,__orig,__num) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
	const size_t __EGdest = (size_t)(__dest);\
	const size_t __EGori = (size_t)(__orig);\
	size_t __EGdmj = __EGdm->row_sz;\
 ...
 * multiply the column stored in #EGdMatrix_t::matrow[*][__colind], wich is 
 ...
 * */
#define EGdMatrixMultiplyCol(__dmatrix,__colind,__mult) do{\
	EGdMatrix_t*const __EGdm = (__dmatrix);\
...
int EGdMatrixGaussianElimination (EGdMatrix_t * const __dmatrix,
