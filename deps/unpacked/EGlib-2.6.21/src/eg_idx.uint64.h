 ...
 * */
#ifndef uint64__EG_IDXNUM_H__
#define uint64__EG_IDXNUM_H__
/** @file
 * @ingroup EGidxNum */
/** @addtogroup EGidxNum */
/** @{ */
...
#define uint64_zeroEGidx ((uint64_t)0U)	/**<@brief zero-valued constant */
#define uint64_oneEGidx 	((uint64_t)1U)	/**<@brief one-valued constant */
#define uint64_MaxEGidx 	UINT64_MAX			/**<@brief maximum representable value */
#define uint64_EGidx_t uint64_t					/**<@brief typedef for modifiable l-value */
#define uint64_EGidxc_t const uint64_t	/**<@brief typedef for constant values */
/* ========================================================================= */
 ...
 * */
#define uint64_EGstrtoIdx(__nptr__,__endptr__,__base__) strtoull(__nptr__,__endptr,__base__)
/* ========================================================================= */
 ...
 * @return EGidx_t
 * detail. */
#define uint64_EG_UL2idx(__EGidxul__)	((uint64_t)(__EGidxul__))
/* ========================================================================= */
 ...
 * */
#define uint64_EGidxIsEqqual(__EGPa__,__EGPb__) ((__EGPa__)==(__EGPb__))
/* ========================================================================= */
 ...
 * */
#define uint64_EGidxIsLess(__EGPa__,__EGPb__) ((__EGPa__)<(__EGPb__))
/* ========================================================================= */
 ...
 * */
#define uint64_EGidxIsLeq(__EGPa__,__EGPb__) ((__EGPa__)<=(__EGPb__))
/* ========================================================================= */
 ...
 * */
#define uint64_EGidxAdd(__EGPa__,__EGPb__)	((uint64_t)((__EGPa__)+(__EGPb__)))
/* ========================================================================= */
 ...
 * */
#define uint64_EGidxSub(__EGPa__,__EGPb__) ((uint64_t)((__EGPa__)-(__EGPb__)))
/* ========================================================================= */
 ...
 * @return  __EGPa__ * __EGPb__
 * */
#define uint64_EGidxMult(__EGPa__,__EGPb__) ((uint64_t)((__EGPa__)*(__EGPb__)))
/* ========================================================================= */
 ...
 * */
#define uint64_EGidxDiv(__EGPa__,__EGPb__) ((uint64_t)((__EGPa__)/(__EGPb__)))
/* ========================================================================= */
/** @brief set the value of the variable to zero */
#define uint64_EGidxZero(__EGPa__) uint64_zeroEGidx
/* ========================================================================= */
/** @brief Reset the value of the pointed number to one.
 * @param __EGPa__ EGidx_t value to be set to one.
 * */
#define uint64_EGidxOne(__EGPa__) uint64_oneEGidx
/* ========================================================================= */
/** @brief unary plus plus operator */
#define uint64_EGidxPP(__EGPa__) ((__EGPa__)++)
/* ========================================================================= */
 ...
 * */
#define uint64_PRIuidxFmt PRIu64
#define uint64_PRIuidxArg(__EGPa__) ((uint64_t)(__EGPa__))
#endif
 /** @} */
/* ========================================================================= */
